...
// Инициализация кнопок настроек cookies
function initCookieSettings() {
    const cookieSettingsLink = document.getElementById('cookieSettingsLink');
    const cookieSettingsLinkMobile = document.getElementById('cookieSettingsLinkMobile');
    ...
    if (cookieSettingsLinkMobile) {
        cookieSettingsLinkMobile.addEventListener('click', (e) => {
            e.preventDefault();
            if (window.cookieConsent) {
                window.cookieConsent.showSettings();
            }
